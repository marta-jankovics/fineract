...
public interface EntityDatatableChecksReadService {
    ...
    List<DatatableData> retrieveTemplates(@NotNull StatusEnum status, @NotNull EntityTables entityTable, Long productId);

    Page<EntityDataTableChecksData> retrieveAll(@NotNull SearchParameters searchParameters, StatusEnum status, EntityTables entityTable,
            Long productId);
}
