...
public final class SavingsTransactionData extends TransactionData {
    ...
    private SavingsTransactionData(@NotNull BigDecimal amount, @NotNull String currency, TransactionEntryType entryType,
    ...
    public static SavingsTransactionData create(@NotNull SavingsAccountTransaction transaction, Map<String, Object> clientDetails,
        ...
        return new SavingsTransactionData(transaction.getAmount(), currency, transaction.getTransactionType().getEntryType(),
