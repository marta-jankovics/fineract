...
public interface ReadWriteNonCoreDataService {
    ...
    CommandProcessingResult updateDatatableEntry(String datatable, Serializable appTableId, Long datatableId, String json);
    ...
    Long countDatatableEntries(String datatable, Serializable appTableId, EntityTables entityTable);
