...
@Service
@Slf4j
public class SavingsStatementGenerationWriteService extends AccountStatementGenerationWriteServiceImpl {

    private final SavingsCamt053StatementGenerator camt053StatementGenerator;

    public SavingsStatementGenerationWriteService(AccountStatementRepository statementRepository,
