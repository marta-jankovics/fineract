...
@Getter
@AllArgsConstructor
public class BinxTransactionEnvelopeData extends EnvelopeData {

    @JsonProperty("OtherIdentification")
    private final TransactionPartiesData relatedParties;

    public static BinxTransactionEnvelopeData create(String debtorIdentification, String debtorScheme, String creditorIdentification,
        ...
        return new BinxTransactionEnvelopeData(parties);
    }
}
