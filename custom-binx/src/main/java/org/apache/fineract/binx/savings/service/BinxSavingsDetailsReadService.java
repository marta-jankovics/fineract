...
public interface BinxSavingsDetailsReadService {

    Map<String, Object> getClientDetails(@NotNull Long clientId);

    Map<String, Object> getAccountDetails(@NotNull Long clientId, @NotNull Long accountId);

    @NotNull
    List<Long> getPendingTransactionIds(@NotNull Long accountId, List<Long> transactionIds);

    Map<Long, Map<String, Object>> getTransactionDetails(List<Long> transactionIds);
