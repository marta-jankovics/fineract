...
public class LoanRepaymentScheduleProcessingWrapper {
    ...
    public static LoanRepaymentScheduleInstallment getInPeriod(LocalDate transactionDate,
            List<LoanRepaymentScheduleInstallment> installments) {
        int firstPeriod = fetchFirstNormalInstallmentNumber(installments);
        for (LoanRepaymentScheduleInstallment installment : installments) {
            if (isInPeriod(transactionDate, installment, installment.getInstallmentNumber().equals(firstPeriod))) {
                return installment;
            }
        }
        return null;
