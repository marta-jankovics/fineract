...
@Getter
public class LoanSameStatusBusinessEvent extends LoanBusinessEvent implements NoExternalEvent {

    private static final String TYPE = "LoanOverpaymentBusinessEvent";

    private final LoanEvent loanEvent;

    public LoanSameStatusBusinessEvent(Loan value, LoanEvent loanEvent) {
        super(value);
