...
public class SavingsAccountsExternalIdTest extends IntegrationTest {
    ...
    void updateSavingsAccountWithExternalId() {
        ...
        Response<PutSavingsAccountsAccountIdResponse> response = okR(fineract().savingsAccounts.update26(EXTERNAL_ID, request, ""));
    ...
    void retrieveSavingsAccountWithExternalId() {
        ...
        Response<GetSavingsAccountsAccountIdResponse> response = okR(fineract().savingsAccounts.retrieveOne34(EXTERNAL_ID, false, "all"));
    ...
    void retrieveSavingsAccountWithExternalIdThirdTime() {
        ...
        Response<GetSavingsAccountsAccountIdResponse> response = Calls
                .executeU(fineract().savingsAccounts.retrieveOne34(EXTERNAL_ID, false, "all"));
