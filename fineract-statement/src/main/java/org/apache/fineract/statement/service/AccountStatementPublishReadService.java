...
public interface AccountStatementPublishReadService {

    boolean isSupport(PortfolioProductType productType);

    Map<StatementType, Map<StatementPublishType, List<AccountStatementPublishData>>> retrieveStatementsToPublish(
