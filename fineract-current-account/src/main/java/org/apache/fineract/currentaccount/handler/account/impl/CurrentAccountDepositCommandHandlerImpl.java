...
@Service
@CommandType(entity = CURRENT_ACCOUNT_ENTITY_NAME, action = ACTION_DEPOSIT)
@RequiredArgsConstructor
public class CurrentAccountDepositCommandHandlerImpl implements CurrentAccountDepositCommandHandler {
