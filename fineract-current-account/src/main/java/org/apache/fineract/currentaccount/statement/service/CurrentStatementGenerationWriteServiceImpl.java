...
public class CurrentStatementGenerationWriteServiceImpl extends AccountStatementGenerationWriteServiceImpl {
    ...
    @Override
    @NotNull
    protected CurrentCamt053Data createContent(@NotNull PortfolioProductType productType, @NotNull StatementType statementType,
            @NotNull StatementPublishType publishType, @NotNull Map<Long, AccountStatement> statements, LocalDate transactionDate) {
        return (CurrentCamt053Data) camt053StatementGenerator.generateContent(productType, publishType, statements);
    }
    ...
    protected String calcResultPath(@NotNull PortfolioProductType productType, @NotNull StatementType statementType,
        ...
        CurrentCamt053Data savingsData = (CurrentCamt053Data) content;
