...
public class CurrentProductDataValidatorImpl implements CurrentProductDataValidator {
    ...
    private static final Set<String> CURRENT_PRODUCT_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(LOCALE_PARAM, NAME_PARAM,
            EXTERNAL_ID_PARAM, SHORT_NAME_PARAM, DESCRIPTION_PARAM, CURRENCY_CODE_PARAM, CURRENCY_DIGITS_AFTER_DECIMAL_PARAM,
            CURRENCY_IN_MULTIPLES_OF_PARAM, ACCOUNTING_TYPE_PARAM, ALLOW_OVERDRAFT_PARAM, OVERDRAFT_LIMIT_PARAM,
            ...
            PAYMENT_CHANNEL_TO_FUND_SOURCE_MAPPINGS_PARAM, DATATABLES_PARAM, STATEMENTS_PARAM));
