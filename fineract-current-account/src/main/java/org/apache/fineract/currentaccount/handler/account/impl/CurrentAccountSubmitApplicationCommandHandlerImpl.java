...
import org.apache.fineract.currentaccount.handler.account.CurrentAccountSubmitApplicationCommandHandler;
...
@Service
@CommandType(entity = CURRENT_ACCOUNT_ENTITY_NAME, action = ACTION_CREATE)
@RequiredArgsConstructor
public class CurrentAccountSubmitApplicationCommandHandlerImpl implements CurrentAccountSubmitApplicationCommandHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ThreadLocalContextUtil.setCommandContext(CommandActionContext.create(CURRENT_ACCOUNT_ENTITY_NAME, ACTION_CREATE));
