...
@Service
@Slf4j
public class CurrentStatementGenerationWriteService extends AccountStatementGenerationWriteServiceImpl {

    private final CurrentCamt053StatementGenerator camt053StatementGenerator;

    public CurrentStatementGenerationWriteService(AccountStatementRepository statementRepository,
            AccountStatementResultRepository statementResultRepository, CurrentCamt053StatementGenerator currentCamt053StatementGenerator) {
        super(statementRepository, statementResultRepository);
        this.camt053StatementGenerator = currentCamt053StatementGenerator;
    }
    ...
    public boolean isSupport(@NotNull PortfolioProductType productType, @NotNull StatementType statementType,
        ...
        return productType == CURRENT && statementType == CAMT053;
    }

    @Override
    @NotNull
    protected Camt053Data createContent(@NotNull PortfolioProductType productType, @NotNull StatementType statementType,
            @NotNull StatementPublishType publishType, @NotNull Map<Long, AccountStatement> statements, LocalDate transactionDate) {
        return camt053StatementGenerator.generateContent(productType, publishType, statements);
    }
    ...
    protected String calcResultCode(@NotNull PortfolioProductType productType, @NotNull StatementType statementType,
            @NotNull StatementPublishType publishType, @NotNull Object content, LocalDate transactionDate) {
        return camt053StatementGenerator.calcResultCode(productType, publishType, content, transactionDate);
    }
    ...
    protected String calcResultPath(@NotNull PortfolioProductType productType, @NotNull StatementType statementType,
        ...
        return camt053StatementGenerator.calcResultPath(productType, publishType, content, transactionDate);
    }
}
