...
import org.apache.fineract.currentaccount.handler.account.CurrentAccountUndoApproveApplicationCommandHandler;
...
@Service
@CommandType(entity = "CURRENTACCOUNT", action = "APPROVALUNDO")
@RequiredArgsConstructor
public class CurrentAccountUndoApproveApplicationCommandHandlerImpl implements CurrentAccountUndoApproveApplicationCommandHandler {
