...
@Getter
@AllArgsConstructor
public class CurrentEnvelopeData extends EnvelopeData {
    ...
    public static CurrentEnvelopeData create(Map<String, Object> clientDetails) {
        if (clientDetails == null || clientDetails.isEmpty()) {
            return null;
        }
        return new CurrentEnvelopeData((String) clientDetails.get("subscription_package"), (String) clientDetails.get("short_name"),
