...
import org.apache.fineract.currentaccount.handler.account.CurrentAccountRejectApplicationCommandHandler;
...
@Service
@CommandType(entity = "CURRENTACCOUNT", action = "REJECT")
@RequiredArgsConstructor
public class CurrentAccountRejectApplicationCommandHandlerImpl implements CurrentAccountRejectApplicationCommandHandler {
