...
import org.apache.fineract.currentaccount.assembler.account.CurrentAccountAssemblerImpl;
import org.apache.fineract.currentaccount.assembler.product.CurrentProductAssembler;
import org.apache.fineract.currentaccount.assembler.product.CurrentProductAssemblerImpl;
...
import org.apache.fineract.currentaccount.service.account.read.CurrentAccountReadServiceImpl;
import org.apache.fineract.currentaccount.service.account.write.CurrentAccountWriteService;
import org.apache.fineract.currentaccount.service.account.write.CurrentAccountWriteServiceImpl;
import org.apache.fineract.currentaccount.service.product.read.CurrentProductReadService;
import org.apache.fineract.currentaccount.service.product.read.CurrentProductReadServiceImpl;
import org.apache.fineract.currentaccount.service.product.write.CurrentProductWriteService;
import org.apache.fineract.currentaccount.service.product.write.CurrentProductWriteServiceImpl;
import org.apache.fineract.currentaccount.validator.account.CurrentAccountDataValidator;
import org.apache.fineract.currentaccount.validator.account.CurrentAccountDataValidatorImpl;
import org.apache.fineract.currentaccount.validator.product.CurrentProductDataValidator;
import org.apache.fineract.currentaccount.validator.product.CurrentProductDataValidatorImpl;
...
public class CurrentAccountAutoConfiguration {
    ...
    public CurrentAccountReadService currentAccountReadService(CurrentAccountRepository currentAccountRepository,
            CurrentProductReadService currentProductReadPlatformService,
            CurrentAccountResponseDataMapper currentAccountResponseDataMapper) {
        return new CurrentAccountReadServiceImpl(currentAccountRepository, currentProductReadPlatformService,
                currentAccountResponseDataMapper);
    }
    ...
    public CurrentAccountDataValidator currentAccountDataValidator(FromJsonHelper fromApiJsonHelper) {
        return new CurrentAccountDataValidatorImpl(fromApiJsonHelper);
    }
    ...
    public CurrentProductDataValidator currentProductDataValidator(FromJsonHelper fromApiJsonHelper) {
        return new CurrentProductDataValidatorImpl(fromApiJsonHelper);
    }
