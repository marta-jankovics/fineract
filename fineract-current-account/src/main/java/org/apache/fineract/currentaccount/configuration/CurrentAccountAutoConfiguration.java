...
public class CurrentAccountAutoConfiguration {
    ...
    public CurrentAccountAssembler currentAccountAssembler(ClientRepository clientRepository,
            ...
            CurrentAccountBalanceReadService currentAccountBalanceReadService, EntityActionRepository entityActionRepository) {
        return new CurrentAccountAssemblerImpl(clientRepository, currentProductRepository, currentAccountRepository, entityActionRepository,
                accountIdentifierRepository, currentAccountBalanceReadService, externalIdFactory);
    }
    ...
    public CurrentProductWriteService currentProductWriteService(CurrentProductRepository currentProductRepository,
                                                                 CurrentProductDataValidator currentProductDataValidator, CurrentProductAssembler currentProductAssembler, EntityManager entityManager) {
        return new CurrentProductWriteServiceImpl(currentProductRepository, currentProductDataValidator, currentProductAssembler, entityManager);
    }
