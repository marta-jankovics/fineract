...
import org.apache.fineract.currentaccount.CurrentProductResponseDataMapper;
...
public class CurrentProductReadServiceImpl implements CurrentProductReadService {
    ...
    public CurrentProductResponseData retrieveById(Long productId) {
        ...
        return currentProductResponseDataMapper.map(currentProductRepository.findCurrentProductData(productId));
    }
