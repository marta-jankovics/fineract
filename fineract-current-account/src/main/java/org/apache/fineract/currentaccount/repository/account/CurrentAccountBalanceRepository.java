...
public interface CurrentAccountBalanceRepository extends JpaRepository<CurrentAccountBalance, String> {
    ...
    CurrentAccountBalanceData getBalance(@Param("accountId") String accountId);
    ...
    List<String> getAccountIdsWhereBalanceRecalculationRequired(@Param("tillDateTime") OffsetDateTime tillDateTime);
