...
import org.apache.fineract.currentaccount.handler.account.CurrentAccountWithdrawApplicationCommandHandler;
...
@Service
@CommandType(entity = "CURRENTACCOUNT", action = "WITHDRAW")
@RequiredArgsConstructor
public class CurrentAccountWithdrawApplicationCommandHandlerImpl implements CurrentAccountWithdrawApplicationCommandHandler {
